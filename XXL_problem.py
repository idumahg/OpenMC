...
p1= CSH.UniformIntegerHyperparameter(name='p1', lower=100000, upper=8000000, default_value=1000000, q=1000)
...
p3 = CSH.UniformIntegerHyperparameter(name='p3', lower=0, upper=100000, default_value=20000, q=100) 
# queuing logic type
...
def myobj(point: dict):
    ...
    x = np.array([point['p0'],point['p1'],point['p2'],point['p3'],point['p4']])
