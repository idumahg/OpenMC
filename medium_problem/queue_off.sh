...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/gidumah/openmc/build_off/install/lib64
export PATH=$PATH:/home/gidumah/openmc/build_off/install/bin

# Running OpenMC
cd /home/gidumah/openmc_offloading_benchmarks/progression_tests/medium
...
mpirun -n $1 openmc --event -i $2 -b $3 > ~/ytopt/ytopt/ytopt/benchmark/OpenMC/medium_problem/output.txt
output=$(cat ~/ytopt/ytopt/ytopt/benchmark/OpenMC/medium_problem/output.txt  | grep particles/second | awk -F' ' '{print $5}')
