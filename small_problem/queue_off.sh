...
# Running OpenMC
cd /home/gidumah/openmc_offloading_benchmarks/progression_tests/small
...
mpirun -n $1 openmc --event -i $2 -b $3 > ~/ytopt/ytopt/ytopt/benchmark/OpenMC/small_problem/output.txt
output=$(cat ~/ytopt/ytopt/ytopt/benchmark/OpenMC/small_problem/output.txt  | grep particles/second | awk -F' ' '{print $5}')
